...
public class NetworkTrafficListView extends LinearLayout {
    private RecyclerView mNetworkList;
    private NetworkTrafficListAdapter mNetworkListAdapter;

    public NetworkTrafficListView(Context context) {
        this(context, null);
    }

    public NetworkTrafficListView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NetworkTrafficListView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        mNetworkListAdapter = new NetworkTrafficListAdapter(getContext());
    ...
    private void initData() {
        synchronized (this) {
            ...
            mNetworkListAdapter.setData(treeSet);
        }
    }
